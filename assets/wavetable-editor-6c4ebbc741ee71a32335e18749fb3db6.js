...
window.requestAnimationFrame(function(){return e.everyFrame()})}},{key:"onResize",value:function(){this.controllers.forEach(function(e){"function"==typeof e.onResize&&e.onResize()})}},{key:"everyFrame",value:function(){var e=this
...
return n=e,(i=[{key:"update",value:function(){}},{key:"isOnScreen",value:function(){return!0}},{key:"render",value:function(){}}])&&t(n.prototype,i),r&&t(n,r),e}()
...
return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&s(e,t)}(i,n.default),u=i,(l=[{key:"update",value:function(e){var n=this
...
var i=1-this.resumeCount/this.resumeLength,r=(0,t.easeInOut)(i,3)
this.animAmt+=r*e/this.period,this.animAmt%=1
var o=.5*Math.cos(2*Math.PI*this.animAmt)+.5
this.slider.value=o,this.onValueChange.forEach(function(e){return e(n.slider.value)})}}},{key:"holdValue",value:function(){var e=this

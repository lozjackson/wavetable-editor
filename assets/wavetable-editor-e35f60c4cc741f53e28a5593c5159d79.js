...
var a=5,s=Ember.Component.extend({peak:Ember.inject.service("devices.peak"),classNames:["wavetable-editor"],hasFourierData:Ember.computed.bool("fourierData"),noData:Ember.computed.not("hasFourierData"),disableDownloadButton:Ember.computed.readOnly("noData"),disableSendButton:Ember.computed.or("noData","peak.notConnected"),generateSyx:function(){var e=this.fourierData,t=e.sort(function(e,t){return e.freq-t.freq}).map(function(e){return Math.floor(16384*e.amplitude)}),n=[]
...
d.start(),this.set("conductor",d)},actions:{sendSysex:function(){var e=this.generateSyx()
...
e.default=n}),define("wavetable-editor/templates/application",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
